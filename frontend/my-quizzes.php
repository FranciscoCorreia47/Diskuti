    ...
    <main class="main">
        <section class="menu vertical">
            <div>
                ...
                <li class="menu-item" data-user-id="<?php echo $_SESSION['id'] ?>"><a href="./my-quizzes.php?user-id=<?php echo $_SESSION['id'] ?>"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><path fill="currentColor" d="M4 20q-.825 0-1.412-.587T2 18V6q0-.825.588-1.412T4 4h6l2 2h8q.825 0 1.413.588T22 8v10q0 .825-.587 1.413T20 20z"/></svg></a></li>
